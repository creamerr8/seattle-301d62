...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT - This error occured because let is not globally scopped so it does not exist after the code block has endded so calling it after casues and error. 
  console.log(viewed);
